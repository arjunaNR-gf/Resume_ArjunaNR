...
useEffect(()=>
{
  ...
  return (
    ...
    <div className={display ? "mobile":"website"}>
      ...
      <div className={windowsidebar?"Side-bar-mobile":"Side-bar"}>
            ...
            <p className="p1" style={{backgroundColor:"navy",padding:"0.5%",textDecorationLine:"underline"}}>  websitecreater:</p>
    ...
    <div className="my-clg-exy">
       ...
       <div className={disheader?"mobile-header":"header"}>
           <p className="p1" style={{margin:"1%"}}>Name : ARJUNA N R | Qualification : MCA(cs),BSc(pcm)</p>
    ...
    <div className="my-clg-ex">
        <p className="p1" style={{width:"30%",padding:"0.1%",marginTop:"2%",backgroundColor:"navy"}}>EXPERIENCE</p>
       ...
       <div style={{display:"flex",marginLeft:"1%"}}> <p><h6>OtherExperience:</h6></p><p> 
           <div style={{width:"98%",height:"auto",padding:"2%",backgroundColor:"white",border:"2px solid lavender"}}> My name is Arjuna N R , I completed my post graduation in MCA at JNNCE shivamogga,
    ...
    <div className="my-clg-ex"><p className="p1" style={{width:"30%",padding:"0.1%",marginTop:"1%",backgroundColor:"navy"}}>EDUCATION</p>
    ...
    <div className="my-clg-ex"><p className="p1"  style={{width:"32%",height:"auto",padding:"0.1%",marginTop:"1%",backgroundColor:"navy"}}>PROGRAMING LANGUAGE KNOWS</p>
    ...
    <div className="my-clg-exy">
     <p className="p1" style={{width:"20%",padding:"0.1%",marginLeft:"1%",marginTop:"1%",backgroundColor:"navy"}}>PROJECT</p>
 ...
 <div style={{width:"90%",height:"auto",backgroundColor:"white",border:"2px solid lavender",marginLeft:"1%"}}>
    ...
    <div className="my-clg-exy">
     <p className="p1" style={{width:"18%",backgroundColor:"navy",padding:"0.1%",marginLeft:"1%",marginTop:"1%"}}>HOBIES</p>
     <table>
